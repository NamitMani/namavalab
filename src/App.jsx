...
const contractAddress = "0x17d5c05698958debb2eae136fce137541ab463e8";
...
function App() {
  ...
  return (
    <div>
      ...
      <main>
        <h3>Hello World</h3>
        <button onClick={fetchHello}>Click me, you know you want to</button>
        <input
          onChange={(e) => setHelloValue(e.target.value)}
          placeholder="Set hello message"
        />
        <button onClick={setHello}>Set hello message</button>
        <div>{hello}</div>
      </main>
    </div>
  );
